...
- **TELEGRAPH_TOKEN** : Telegraph token generate by [Clickig Here](https://telegraph-token.sonywegas.repl.run) **OR** you can generate by running:
```
...
- **USER_SESSION_STRING** : Generate String session by [Clickig Here](https://string-session.sonywegas.repl.run) **OR** you can generate by running :
```
